...
#define PARSEC_ACTION_RECEIVE_DIRECT_DEPS         0x00100000
#define PARSEC_ACTION_RELEASE_DIRECT_DEPS         0x00200000
...
#   define direct_send(es, rank, deps) remote_dep_dequeue_direct_send(es, rank, deps)
