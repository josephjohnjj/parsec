...
typedef enum {
    ...
    PARSEC_MIG_TASK_DETAILS_TAG,
    PARSEC_MIG_DEP_GET_DATA_TAG,
    PARSEC_MIG_STEAL_REQUEST_TAG, 
    PARSEC_MIG_INFORM_PREDECESSOR_TAG,
    PARSEC_MIG_DEP_DIRECT_ACTIVATE_TAG,
    PARSEC_MIG_NO_GET_DATA_TAG,
    PARSEC_MIG_ACK_MAPPING,
    PARSEC_RECEPTION_ACK,
    PARSEC_MIG_ACK_TASK_RECEPTION,
